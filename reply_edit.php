<?php
    ...
    $result = mysqli_query($link, "SELECT * FROM replies WHERE id = $delete_number");
...
<body>
    ...
    <div class="border">
        <form action="./reply_update.php" method="post" enctype="multipart/form-data" border="2" bordercolor="#00CCFF">
            <table>
                <tr>
                    <td>名前</dh>
