    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo "<div class=\"border\">";
                ...
                <div class="buttom">
                    <form action="./reply.php" method="post" enctype="multipartform-data">
                    <?php echo "<input type =\"submit\" value=\"返信\">"; ?>
                    <input type="hidden" name="reply_number" value="<?php echo $row["id"]; ?>">
                    </form>
