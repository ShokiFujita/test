...
<body>
    ...
    <?php
        ...
        if(!empty($image_path)){
            $sql = "INSERT INTO boards(name, subject, message, image_path, email, url, text_color, delete_key, created_at) VALUE ('$name', '$subject', '$message', '$image_path', '$email', '$url', '$text_color', $delete_key, now())";
        }   else{
            $sql = "INSERT INTO boards(name, subject, message, email, url, text_color, delete_key, created_at) VALUE ('$name', '$subject', '$message', '$email', '$url', '$text_color', $delete_key, now())";
        }
